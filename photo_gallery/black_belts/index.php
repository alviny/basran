...
?>
	<td valign="top">
		...
		<table width="150" cellpadding="2" cellspacing="0">
		 <tr>
			<td style="border-style: solid; border-width: 1px; border-color: #999999;"><a href="images/<?=$image[$x][0] . '.' . $image[$x][2];?>" rel="lightbox[gallery]" title="<?=$image[$x][1];?>"><img src="images/<?=$image[$x][0] . '_sm.' . $image[$x][2];?>" width="150" height="200" border="0" alt="<?=$image[$x][1];?>"></a></td>
		 </tr>
		 <tr>
